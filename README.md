...
**Important**: Synapse does NOT read environment variables from .env. You must replace the placeholders in this file with the actual secret strings.
...
| Platform | How to connect |
|----------|---------------|
| Browser | Login at chat.yourdomain.com |
